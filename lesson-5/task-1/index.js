...
4. В том случае если объект валидный промис резолвится с текстом `Пользователь верифицирован`;
5. В том случае если объект невалидный промис реджектится с текстом `Пользователь не верифицирован`.
*/

// РЕШЕНИЕ
const isCustomerVerified = (user) => {
    return new Promise((resolve, reject) => {
        if (user.name && user.verified === true) resolve('Пользователь верифицирован');
